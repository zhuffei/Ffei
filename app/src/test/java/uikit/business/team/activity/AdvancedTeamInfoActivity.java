...
public class AdvancedTeamInfoActivity extends UI implements TAdapterDelegate, TeamMemberAdapter.AddMemberCallback,
    ...
    private void initNotify() {
        ...
        notificationConfigText = layoutNotificationConfig.findViewById(R.id.item_detail);
    ...
    private void findLayoutAuthentication() {
        ...
        authenticationText = layoutAuthentication.findViewById(R.id.item_detail);
    ...
    private void findLayoutInvite() {
        ...
        inviteText = layoutInvite.findViewById(R.id.item_detail);
