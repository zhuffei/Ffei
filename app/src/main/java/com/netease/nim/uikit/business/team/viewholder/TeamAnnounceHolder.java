...
public class TeamAnnounceHolder extends TViewHolder {
    ...
    protected void inflate() {
        announceTitle = view.findViewById(R.id.announce_title);
        teamName = view.findViewById(R.id.team_name);
        announceCreateTime = view.findViewById(R.id.announce_create_time);
        announceContent = view.findViewById(R.id.announce_content);
    }
