...
//
//public class AvatorActivity extends ActionBarActivity {
//
//    /* 头像文件 */
...
//
//        Button buttonLocal = (Button) findViewById(R.id.local);
...
//            Toast.makeText(getApplication(), "操作取消", Toast.LENGTH_LONG).show();
//            return;
//        }
//
//        switch (requestCode) {
