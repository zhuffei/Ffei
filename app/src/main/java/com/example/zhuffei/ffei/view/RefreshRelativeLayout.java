...
public class RefreshRelativeLayout extends RelativeLayout {
    ...
    private void initView() {
        ...
        rlyHead = getHeadLayout(findViewById(R.id.rly_refresh_head));
        rlyFoot = getFootLayout(findViewById(R.id.rly_refresh_foot));

        rlyHeadState1 = getHeadState1Layout(findViewById(R.id.rly_head_state_1));
        rlyHeadState2 = getHeadState2Layout(findViewById(R.id.rly_head_state_2));
        rlyHeadState3 = getHeadState3Layout(findViewById(R.id.rly_head_state_3));
        rlyHeadState4 = getHeadState4Layout(findViewById(R.id.rly_head_state_4));

        rlyFootState1 = getFootState1Layout(findViewById(R.id.rly_foot_state_1));
